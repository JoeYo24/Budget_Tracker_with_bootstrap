    ...
    return (
        <div className="helpPage">
            ...
            <div className="helpContainer">
                ...
                <p>Start by adding some transactions to your diary. You can do this by clicking on the <a href="/my-diary/transaction">'Add Transaction'</a> button on the <a href="/my-diary">'My Diary'</a> page.</p>
                ...
                <p>From the <a href="/my-diary">'My Diary'</a> page, you can view your transactions or delete them.</p>
